...
Videogame.belongsToMany(Platform, { through: 'videogame_platforms', timestamps: false });
Platform.belongsToMany(Videogame, { through: 'videogame_platforms', timestamps: false });
