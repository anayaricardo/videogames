...
export function getAllVideogames() {
  // Esta función se encarga de llamar a la API y obtener todos los videojuegos
  try {
...
export function getAllGenres() {
  // Esta función se encarga de llamar a la API y obtener todos los géneros
  try {
...
export function getAllPlatforms() {
  // Esta función se encarga de llamar a la API y obtener todos los plataformas
  try {
    return function (dispatch) {
...
export const getGamesByName = (name) => {
  // Esta función se encarga de llamar a la API y obtener todos los videojuegos que coincidan con el nombre
  return async function (dispatch) {
    try {
...
export function getGameDetails(id) {
  // Esta función se encarga de llamar a la API y obtener los detalles de un videojuego
  try {
    return async function (dispatch) {
...
export function filterGamesByGenre(payload) {
  // Esta función se encarga de filtrar los videojuegos por género
  console.log(payload);
  return {
...
export function filterCreatedOrExist(payload) {
  // Esta función se encarga de filtrar los videojuegos por si ya existen o no
  return {
...
export function sortAlphabetically(payload) {
  // Esta función se encarga de ordenar los videojuegos alfabéticamente
  return {
...
export function sortByRating(payload) {
  // Esta función se encarga de ordenar los videojuegos por puntuación
  return {
    type: SORT_BY_RATING,
    payload: payload,
  };
...
export function clearStateDetail(payload) {
  // Esta función se encarga de limpiar el estado de los detalles de un videojuego
  return {
...
export function clearStateVideogames(payload) {
  // Esta función se encarga de limpiar el estado de los videojuegos
  return {
